package shentong.spider.proxy.model;
...
public class ProxyPool {
    ...
    public Map<String, Proxy> getAllProxy() {
        return allProxy;
    }

    public void setAllProxy(Map<String, Proxy> allProxy) {
...
//        timer.schedule(saveProxyTask, 10 * 60 * 1000L, 10 * 60 * 1000);
    ...
    public List<HttpHost> getProxyQueue(List<String[]> httpProxyList) {
        addProxy(httpProxyList.toArray(new String[httpProxyList.size()][]));
